...
const steps = [
  {
    ...
    description:
      "Start by exploring our extensive library of humanitarian and environmental datasets sourced from around the globe.",
  ...
  },
  {
    ...
    description:
      "Our dedicated AI agents guide you through every step, extracting patterns and providing key insights automatically.",
  ...
  },
  {
    ...
    title: "Submit & Earn",
    description:
      "Join our community of volunteers. Submit your own data and build your reputation with verified contributions.",
          ...
          {steps.map((step, index) => (
            ...
            >
              <div className="absolute top-8 left-8 z-20">
                ...
                <h3 className="text-3xl font-bold mt-2 text-[#2d4a77]">{step.title}</h3>
              </div>
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8 pt-20 bg-gradient-to-t from-white/90 via-white/40 to-transparent">
                <p className="text-[#2d4a77] font-medium leading-relaxed">{step.description}</p>
              </div>
            </motion.div>
          ))}
        </div>
