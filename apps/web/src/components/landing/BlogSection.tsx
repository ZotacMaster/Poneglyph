...
const posts = [
  {
    ...
    summary:
      "A major milestone in our journey to democratize data for NGOs and researchers worldwide.",
    link: "#",
  },
  {
    ...
    <section className="relative w-full py-32 px-4 bg-white/5">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
          ...
          <a
            href="#"
            className="bg-[#1e1e1e] text-white px-8 py-4 rounded-2xl flex items-center gap-2 hover:bg-[#333] transition-all self-start md:self-auto shadow-xl"
          >
          ...
          {posts.map((post, index) => (
            ...
            >
              ...
              <div className="flex flex-col space-y-4">
                ...
                <p className="text-lg text-[#2d4a77]/60 font-medium line-clamp-2">{post.summary}</p>
              </div>
            </motion.a>
          ))}
        </div>
