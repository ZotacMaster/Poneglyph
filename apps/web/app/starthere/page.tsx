...
const steps = [
  {
    ...
    description: "Sign up in under 2 minutes. Volunteers are always free. NGO plans include a 14-day free trial — no credit card required.",
    cta: "Start free",
    href: "/pricing",
  },
  {
    ...
    description: "Volunteers: add your skills, availability, and causes you care about. NGOs: create your organization profile and add your first project.",
  ...
  },
  {
    ...
    description: "Our AI starts working immediately — surfacing the best volunteer-to-project matches and generating your first impact analytics.",
      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="container-max flex flex-col items-center gap-6 text-center relative z-10">
          ...
          <p className="text-body text-grey-1 max-w-md">
            Everything you need to start using Poneglyph — guides, tutorials, and step-by-step walkthroughs for volunteers and NGOs.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 bg-white">
        <div className="container-max flex flex-col gap-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {steps.map((s) => (
              <div key={s.step} className="flex flex-col gap-5 p-7 bg-grey-4 border border-grey-3 rounded-2xl">
